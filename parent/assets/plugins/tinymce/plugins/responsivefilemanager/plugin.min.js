tinymce.PluginManager.add("responsivefilemanager", function (e) {
  function n(t) {
    0 ===
      e.settings.external_filemanager_path
        .toLowerCase()
        .indexOf(t.origin.toLowerCase()) &&
  ...
  function t() {
    var t = window.innerWidth - 120,
      i = window.innerHeight - 140;
    ...
    var r = "key";
    "undefined" != typeof e.settings.filemanager_access_key &&
    ...
    "undefined" != typeof e.settings.filemanager_sort_by &&
      ...
      (o = "&sort_by=" + e.settings.filemanager_sort_by);
    var g = "false";
    "undefined" != typeof e.settings.filemanager_descending &&
      e.settings.filemanager_descending &&
      (g = e.settings.filemanager_descending);
    var d = "";
    "undefined" != typeof e.settings.filemanager_subfolder &&
