...
class School_mentoring extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['main_content'] = 'mentors/index';
	...
	public function add_mentor()
	{
		...
		$data['main_content'] = 'mentors/add_mentors';
		$this->load->view('dash_template/body', $data);
	}
	...
	public function edit_mentor($id)
	{
		...
		$data['main_content'] = 'mentors/edit_mentor';
		$this->load->view('dash_template/body', $data);
	}
							...
							<td class="text-end">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end">
									   <a href="'. base_url('admin/edit_mentor/') . $value->id .'" class="dropdown-item">Edit</a>
	...
	public function reset_password($id){
		...
		$data['id'] = $id;
		$data['main_content'] = 'mentors/reset_password';
		$this->load->view('dash_template/body',$data);
			...
			if ($this->bcrypt->check_password($password, $stored_password)) {
				...
				if($result){
					...
					$msg='<div class="alert alert-success">
					  ...
					  <strong>Password Updated Successfully</strong></div>';
					$url = base_url().'mentors/reset_password/'.$id;
				}else{
					$status = 0;
					$msg='<div class="alert alert-warning">
