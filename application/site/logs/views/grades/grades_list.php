...
<?php if(isset($this->url_slug) && !empty($this->url_slug)){ ?>
  <div class="page-container">
			...
			<div class="page-header no-gutters">
				<div class="row align-items-md-center">
					...
					<div class="col-md-6 ">
						<h3 class="m-b-0">
						    <a class="text-dark" href="javascript:void(0);">Grades List - <?= $schools->name ?></a>
						</h3>
 ...
 <?php }else{ ?>
  <div class="col-md-9" id="app">
   ...
   <h2>Grades List - <?= $schools->name ?></h2>
                ...
                <div class="card-body">
                    <div class="d-md-flex gap-4 align-items-center">
                        ...
                        <div class="dropdown ms-auto">
                            <a href="<?= base_url($_SESSION["login_session"]["url_slug"].'/grades/add/'.$urlid) ?>">
                                ...
                                <td class="text-end">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
											...
											<a  href="javascript:void(0);"  data-did="<?= $value->id ?>" data-tbl="grades" data-ctrl="grades"  data-sid = "<?= $schools->id ?>"  class="dropdown-item text-danger delete_class">Delete</a>		
