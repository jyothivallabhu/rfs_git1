					...
					<div class="card">
						<div class="card-body">
								...
								<div class="d-md-flex align-items-center justify-content-center d-none">
									...
									<div class="media align-items-center m-v-5">
										...
										<div>
										    <p class="m-b-0">Approved</p>
										    <h2 class="m-b-0">
											<span id="mentoringapproved"><?= $mentoringapproved ?></span>
										    </h2>
										</div>
									</div>
								</div>
							...
							<div class="text-center m-t-30">
								<a href="<?=base_url($this->url_slug.'/teacher_mentoring/add') ?>" class="btn btn-primary text-center">
