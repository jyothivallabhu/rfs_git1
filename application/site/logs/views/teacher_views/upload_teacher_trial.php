							 ...
							 <form action="<?=base_url('teacher_trial/create')?>" method="post" enctype="multipart/form-data" name="teacher_trial_form" id="teacher_trial_form" class="form_class">
								 <?php $this->load->view('include/msgs'); ?>
									...
									<!--<div class="form-group">
										...
										<input class="form-control" type="text" name="class_name" value="<?= $classes['class_name'] ?>" readonly> 
										<input class="form-control" type="hidden" name="class_id" value="<?= $classes['c_id'] ?>"> 
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="class_name" value="<?= $lessons['lesson_name'] ?>" readonly> 
										<input class="form-control" type="hidden" name="lesson_id" value="<?= $lessons['lesson_id'] ?>"> 
