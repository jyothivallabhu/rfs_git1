...
<div class="content ">
    ...
    <div class="card col-md-9 mb-3" id="app">
        <div class="card-body">
			<form class="mb-5" id="reset_password" action="<?= site_url('mentors/update_password/'.$id) ?>" method="post">
			  ...
			  <div class="mb-3 col-6">
			   ...
			   <input name="submit" type="submit" class="btn btn-primary">			</form>
        </div>
    </div>
