                ...
                <div class="card-body d-flex flex-column gap-3">
                    <div class="d-flex justify-content-between align-items-center row">
                        ...
                        <span class="col-md-1 badge <?= $status_badge ?>"><?= ($value->status == '1')? 'Active' : 'Inactive'  ?></span>
						        ...
						        <div class="d-flex col-md-1">
                                   ...
                                   <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
											...
											<a class="dropdown-item" data-bs-toggle="collapse" href="#collapseExample<?= $value->c_id ?>" role="button" aria-expanded="false" aria-controls="collapseExample"> Edit </a>
								...
								<div class="collapse" id="collapseExample<?= $value->c_id ?>">
									<div class="card card-body">
										<form class="mb-5 form_class" id="" method="POST" action="<?= site_url('classes/update_class/'.$value->c_id ) ?>" >
											<div class="row mb-3">
												<div class="col-md-4">
													<label class="form-label">Class Name</label>
