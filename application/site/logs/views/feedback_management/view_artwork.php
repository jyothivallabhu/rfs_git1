					...
					<div class="col-md-4 text-center">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="media align-items-center">
                                                <div class="">
                                                    <img src="<?= base_url('parent/'.$artworks->artwork_upload) ?>" class="img-fluid">
                                                </div>
												<?php $artworks; ?>
						...
						<div class="card-body">
							<div class="m-t-20">
								...
								<div id="msg"></div>
							<form class="mb-5 form_class" id="feedbackform" method="POST" action="<?= site_url('feedback_management/save_artworkfeedback') ?>">
