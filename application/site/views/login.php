    ...
    <div class="container">
        <div class="card">
			...
			<div class="col d-none d-lg-flex border-start align-items-center justify-content-between flex-column text-center">
                        ...
                        <div>
                            <img class="img-fluid" src="<?= (isset($featured_image['final_artwork']) && (file_exists($featured_image['final_artwork'])) != '' ? base_url( $featured_image['final_artwork']) : base_url('assets/images/bamboo.png') )  ?>">
                        </div>
