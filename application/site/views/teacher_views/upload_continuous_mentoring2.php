			...
			<div class="page-header no-gutters">
				<div class="row col-12 align-items-md-center">
					...
					<div class="col-md-4 col-10 text-left">
						<h3 class="m-b-0">
						...
						<div class="card-body">
							 ...
							 <form action="<?=base_url('teacher_continuous_mentoring/create')?>" method="post" enctype="multipart/form-data" name="teacher_mentoring" id="teacher_mentoring" class="form_class">
								 <?php $this->load->view('include/msgs'); ?>
									...
									<div class="form-group">
										<label for="inputState" class="form-label">Lesson <span style="font-bold">*</span></label>
								...
								<div class="form-group">
									...
									<div id="ic-main" class="ibox m-b-10">
										<div class="ic-btns clearfix">
											<div id="ic-upload-btn1"  data-id="1"  class="l but lrg file-button w3-button w3-blue ic-upload-btn">
												<span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Image1</span>
												<input class="file-input" accept="image/*"   type="file" name="artwork_upload" required />
											  ...
											  <div id="ic-cropper-wrap"></div>
												<div class="ic-hidden ic-crop-btn-wrap"><br />
													<div id="ic-rotate-btn" class="l but lrg w3-button w3-grey">
														...
														<div id="ic-flip-btn" class="l but lrg w3-button w3-grey">Flip</div> <a id="ic-crop-btn" data-id = "1"  class="l but lrg w3-button w3-grey">Done</a>
													</div>
									...
									<div id="ic-main" class="ibox m-b-10">
										<div class="ic-btns clearfix">
											<div id="ic-upload-btn1"  data-id="2"  class="l but lrg file-button w3-button w3-blue ic-upload-btn">
												<span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Image2</span>
												<input class="file-input" accept="image/*"   type="file" name="artwork_upload" />
												<input id="base_code2" type="hidden" name="base_code2" value="">
											</div>
										</div>
										<!-- Modal -->
										
										<div id="ic-cropper-wrap2"></div> 
									</div>
									
									<div id="ic-main" class="ibox m-b-10">
										<div class="ic-btns clearfix">
											<div id="ic-upload-btn1"  data-id="3"  class="l but lrg file-button w3-button w3-blue ic-upload-btn">
												<span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Image3</span>
												<input class="file-input" accept="image/*"   type="file" name="artwork_upload" />
												<input id="base_code3" type="hidden" name="base_code3" value="">
											</div>
										</div>
										<!-- Modal -->
										 
										<div id="ic-cropper-wrap3"></div> 
									</div>
									
									<div id="ic-main" class="ibox m-b-10">
										<div class="ic-btns clearfix">
											<div id="ic-upload-btn1"  data-id="4"  class="l but lrg file-button w3-button w3-blue ic-upload-btn">
												<span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Image4</span>
												<input class="file-input" accept="image/*"   type="file" name="artwork_upload" />
												<input id="base_code4" type="hidden" name="base_code4" value="">
											</div>
										</div>
										<!-- Modal -->
										 
										<div id="ic-cropper-wrap4"></div> 
									</div>
									
									<div id="ic-main" class="ibox m-b-10">
										<div class="ic-btns clearfix">
											<div id="ic-upload-btn1"  data-id="5"  class="l but lrg file-button w3-button w3-blue ic-upload-btn">
												<span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Image5</span>
												<input class="file-input" accept="image/*"   type="file" name="artwork_upload" />
												<input id="base_code5" type="hidden" name="base_code5" value="">
											</div>
										</div>
										<!-- Modal -->
										 
										<div id="ic-cropper-wrap5"></div> 
									</div>
								...
								<div class="form-group">
										<label for="inputState" class="form-label">Stage</label>
										 <select name="stage" id="stage" class="form-control  valid" required>
								...
								<div class="form-group ">
									...
									<div id="loading-div"></div>
										...
										<a href="<?=base_url($this->url_slug.'/teacher_mentoring')?>" class="btn btn-primary-outline">Cancel</a>
										<button class="btn btn-primary" id="teacher_mentoring_submit">Submit</button>
									</div>
								</div>
...
$(document).on('change', '.ic-upload-btn', function (a) {
	const $this = $(this); // Cache $(this)
	const dataVal = $this.data('id'); // Get data value
	 
	$('#ic-crop-btn').data("id",dataVal);
        ...
        if (!b) return !1;
		 ...
		 const $this2 = $(this); // Cache $(this)
		const dataVal2 = $this2.data('id'); // Get data value
        ...
        var a = "image/png" === $("#ic-download-type").val() ? "image/png" : "image/jpeg",
           ...
           $("#base_code"+dataVal2).val(c);
            $("#ic-cropper-wrap"+dataVal2).html('<img class="result-image" src="' + c + '" style="width: 100%;height:250px;" />'); 
...
/* $(document).on('click', '.ic-upload-btn', function (a) {
