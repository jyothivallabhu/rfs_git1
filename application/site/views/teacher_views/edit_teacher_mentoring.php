							 ...
							 <form action="<?=base_url('teacher_continuous_mentoring/update')?>" method="post" enctype="multipart/form-data" name="teacher_mentoring" id="teacher_mentoring" class="form_class">
								 <?php $this->load->view('include/msgs'); ?>
									...
									<div class="form-group">
										...
										<select class="form-control required" id="section_id" name="section_id" required>
										<?php 
											if(!empty($sections)){	
												foreach ($sections as $key => $c) {
												?>
												<option value="<?= $c['section_id'] ?>" <?= ($c['section_id'] == $view_data['section_id']) ? 'selected' : '' ?>><?=  ucwords($c['section_name'])  ?></option>
									...
									<div class="form-group">
										<label for="inputState" class="form-label">Lesson</label>
										 ...
										 <select name="lesson_id" required id="lesson_id" class="form-control required valid" >
								...
								<div class="form-group">
									...
									<div id="ic-main" class="ibox m-b-10">
										...
										<div id="ic-cropper-wrap1">
										<?php 
										if(!empty($view_data['image_path'])){
												echo '<img src="'.$view_data["image_path"].'" height="60" width="60" />';
											} ?>
										</div> 
									</div>
