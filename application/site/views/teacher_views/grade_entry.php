				...
				<div class="col-md-6 col-lg-6 offset-lg-3">
					<div class="card">
						<div class="card-body">
							 ...
							 <form action="<?=base_url('grade_entry/create')?>" method="post" enctype="multipart/form-data" name="teacher_mentoring" id="teacher_mentoring" class="form_class">
								 <?php $this->load->view('include/msgs'); ?>
									...
									<div class="form-group">
										<label for="first_name" class="form-label">Students</label>
										<select class="form-control  valid"  data-id="1" id="student_id" name="student_id" >
								...
								<div class="form-group">
										<label for="inputState" class="form-label">Grade</label>
										 <select name="grade_id" id="grade_id" class="form-control  valid" required>
								...
								<div class="form-group">
									<label class="font-weight-semibold" for="comments"> Comments</label>
