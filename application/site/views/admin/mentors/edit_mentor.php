    ...
    <div class="row row-cols-1 row-cols-md-3 g-4" id="app">
        <div class="col-lg-8 col-md-8 offset-lg-2">
            <div class="card widget">
                ...
                <?php //print_r($mentor); ?>
                <form class="mb-5 form_class" id="edit_mentor" method="POST" action="<?= site_url('mentors/update_mentor/') . $mentor->id ?>">
                    <div class="row">
                        ...
                        <div class="mb-3 col-6 ">
                            ...
                            <input type="text" value="<?= $mentor->last_name ?>" class="form-control" name="last_name" id="last_name" required <?= ($mentor->status== '0') ?  'readonly' : '' ?>>
                        </div>
                        <div class="mb-3 col-6 ">
