                ...
                <div class="card-body">
                    <div class="d-md-flex gap-4 align-items-center">
                        ...
                        <div class="dropdown ms-auto">
                            <a href="<?= base_url('offline_schools/add_school') ?>">
                                <button class="btn btn-outline-primary">
                                    <i class="bi bi-plus-circle me-2"></i> Add Offline School
                                </button>
                            </a>
                        </div>
                    </div>
						...
						foreach ($schools as $key => $value) {
						 ...
						 ?>
							...
							<!--<td> <a href="<?php echo  base_url('school_dashboard/'.$value->school_id) ?>" ><img src="<?= $value->image_path ;?>" height="" width="100"  /> </a></td>-->
								...
								<td><a href="<?php echo  base_url('offline_schools/downloadFile/'.$value->school_id) ?>"><i class="bi bi-download"></i> Download</a></td>
                                ...
                                <td class="text-end">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="<?= base_url('offline_schools/edit_school/') . $value->school_id ?>" class="dropdown-item">Edit</a>
                                            
											<a  href="javascript:void(0);"  data-did="<?= $value->school_id ?>" data-tbl="offline_schools" data-ctrl="offline_schools"  class="dropdown-item text-danger delete_class">Delete</a>
