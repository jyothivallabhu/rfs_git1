            ...
            <div class="card widget">
                ...
                <form class="mb-5 form_class" id="edit_school" method="POST" action="<?= site_url('schools/update_school/') . $school->id  ?>" enctype="multipart/form-data">
                    <div class="row">
						...
						<div class="mb-3 col-6">
                            <label for="school_image" class="form-label">App logo <small style="color:red">(60*60px preferred) </small></label>
                            <input type="file" class="form-control" name="school_app_image" id="school_app_image" <?= ($school->status== '0') ?  'disabled' : '' ?>>
							
							<img src="<?= base_url().$school->app_logo ;?>" height="60" width="60" style="margin-top: 8px;" /> 
