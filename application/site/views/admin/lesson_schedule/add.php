				...
				<?php 
                    ...
                    <div id="preItems">
						<div class="row addpre_option" style="margin-right: -140px;">
							...
							<select id="class_id"  name="class_id[0]"  class="form-control class_id" required>
								...
								if(!empty($classes)){
									...
									?>
												<option value="<?=  $value->c_id.'-'.$c['section_id'] ?>" data-id="0"><?=  $value->class_name.' - '.$c['section_name'] ?></option>
									<?php  
											}
										}
									}
                        ...
                        <select id="lesson_id-0" name="lesson_id[0]" class="form-control" required >
                            <option value="">Select</option>
							<?php 
							/* if(!empty($lessons)){
							...
							<div class="col-md-2">
								<label for="name" class="form-label">	From Date</label>
									<input type="date" name="from_date[0]"  required class="form-control" placeholder="Enter Option"  aria-label="Recipient's username" aria-describedby="basic-addon2">
									
							</div>
							<div class="col-md-2">
								<label for="name" class="form-label">	To Date</label>
									<input type="date" name="to_date[0]" required class="form-control" placeholder="Enter Option"  aria-label="Recipient's username" aria-describedby="basic-addon2">
