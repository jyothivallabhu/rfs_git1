   ...
   <div class="row g-4 mb-4">
	...
	<?php if(isset($this->url_slug) && !empty($this->url_slug)){ ?>
				  <div class="page-container">
							...
							<div class="page-header no-gutters">
								<div class="row align-items-md-center">
									...
									<div class="col-md-6 ">
										<h3 class="m-b-0">
											<a class="text-dark" href="javascript:void(0);"> School Teachers - <?= $schools->name ?></a>
										</h3>
				 ...
				 <?php }else{ ?>
				   ...
				   <div class="row g-4 mb-4">
				   <h2>School Teachers - <?= $schools->name ?></h2>
				...
				<div class="d-md-flex gap-4 align-items-center">
					<div class="d-md-flex gap-4 align-items-center">
						<div class="mb-3 mb-md-0">
							<div class="row g-3">
								<!--<div class="col-md-3">
									<select class="form-select" onclick="searchFilter1()" id="school_name">
					...
					<div class="dropdown ms-auto">
						<a href="<?= base_url($_SESSION["login_session"]["url_slug"].'/teachers/add/'.$urlid) ?>">
							<button class="btn btn-outline-primary">
								<i class="bi bi-plus-circle me-2"></i> Add School Teachers
							</button>
						</a>
					</div>
					<?php //} ?>
							...
							<td class="text-end">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end">
									   ...
									   <a href="<?= base_url('teachers/del/') . $value->school_id .'/'.$value->id ?>" class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to Delete?');">Delete</a>--> 
										
										<a href="<?= base_url($_SESSION["login_session"]["url_slug"].'/teachers/edit/').$value->id ?>" class="dropdown-item editschool_admin" data-school_id="<?= $value->school_id ?>" data-uid="<?= $value->id ?>" data-url_slug="<?= $_SESSION["login_session"]["url_slug"] ?>" >Edit</a>
...
function searchFilter1(page_num) {			 
		...
		$.ajax({
			type: 'POST',
			url: '<?=base_url("/teachers/ajaxPaginationSAdminData/")?>'+page_num,
