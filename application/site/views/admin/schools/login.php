               ...
               <!-- <div class="col-lg-4 d-none d-lg-flex bg" >
                ...
                <div class="col-lg-12 bg-white">
                    <div class="h-100 m-t-100" style="margin-left:15px;margin-right:15px">
                        ...
                        <div class="col-md-6 m-t-10 col-6"><img src="<?= base_url() ?>assets/school_assets/images/rainbowfish_logo.png" class="img-fluid logo-responsive" alt="" style="height: 70px;"></div>
							<div class="col-md-6  col-6 text-right client-logo"><?= $image ?></div>
						</div>
						<? $errmsg ?>
