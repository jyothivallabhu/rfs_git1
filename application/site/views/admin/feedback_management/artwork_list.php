								...
								<td class="text-end">
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end">
											...
											<a href="javascript:void(0);"  data-did=<?= $req->id ?> data-sid=<?= $req->school_id ?>  data-tbl="feedback_management" data-ctrl="feedback_management"  class="dropdown-item text-danger delete_class">Delete</a>
											<?php //} ?>
