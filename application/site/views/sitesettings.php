<!-- content -->
 ...
 <?php } ?>
    ...
    <div class="card col-md-9 offset-lg-2" style="margin-bottom: 250px;">
        <div class="card-body">
			<form class="mb-5" id="reset_password" action="<?= site_url('sitesettings/save') ?>" method="post">
			  ...
			  <div class="mb-3 col-6">
				...
				<input type="color" value="<?= ($this->headerdata) ? $this->headerdata : '#3f87f5' ?>" name="color_code" required style="width:50px;height:30px;margin-left:30px;">
			  </div>
			 
			 <div class="mb-3 col-6">
				<label for="title" class="form-label">Default Color</label>
				<input type="checkbox" value="default" name="default_color" style="width:40px;height:20px;margin-left:30px;">
			  </div>
