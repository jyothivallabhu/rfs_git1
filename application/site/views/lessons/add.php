                ...
                <form id="upload-form" id="lessons_add_form" class="upload-form form_class" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12 ">
                            ...
                            <input type="text" class="form-control" name="artist_art_movement" id="artist_art_movement" >
                        </div>
                        ...
                        <div class="mb-3 col-12">
							...
							<input type="file" class="form-control" name="teachers_note" id="teachers_note"  >
                            <pre id="output"></pre>
                        </div>
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="file" class="form-control" name="introduction_video" id="introduction_video" >
                        </div>
                        <div class="mb-3 col-12">
                            ...
                            <input type="file" class="form-control" name="demonstration_video" id="demonstration_video" >
                        </div>
