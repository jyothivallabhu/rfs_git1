...
.header ul.navbar-nav li.nav-item a:hover:after { 
  ...
  left: 0; 
				...
				if($_SESSION['login_session']['role_id'] == 2){
				    ...
				    ?>
				    <li class="nav-item">
                        <a href="<?= base_url('mentor_dashboard') ?>" class="nav-link ">
                            Dashboard
                        </a>
                    </li>
					<li class="nav-item">
                        <a href="<?= base_url('mentor_schools') ?>" class="nav-link ">
                            Schools
                        </a>
                    </li>
			...
			<div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a href="<?= base_url('changepwd') ?>" class="dropdown-item d-flex align-items-center ">
                            <i class="bi bi-person dropdown-item-icon"></i> Change Password
                        </a>
						<a href="<?= base_url('sitesettings') ?>" class="dropdown-item d-flex align-items-center ">
                            <i class="bi bi-gear dropdown-item-icon"></i> Site Settings
                        </a>
						<?php if($_SESSION['login_session']['role_id'] != 5) { ?>
						<a href="<?= base_url('admin/academic_details') ?>" class="dropdown-item d-flex align-items-center ">
                            <i class="bi bi-gear dropdown-item-icon"></i> Academic Settings
                        </a>
						<?php } ?>
						
						<a href="<?= base_url('get_help_list') ?>" class="dropdown-item d-flex align-items-center ">
                            <i class="bi bi-person dropdown-item-icon"></i> Get Help
                        </a>
						
                        <a href="<?= base_url('logout') ?>" class="dropdown-item d-flex align-items-center ">
                            <i class="bi bi-box-arrow-right dropdown-item-icon"></i> Logout
                        </a>
                    </div>
                </div>
