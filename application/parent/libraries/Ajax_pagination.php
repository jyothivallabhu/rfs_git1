...
class Ajax_pagination{
    ...
    /* var $next_link       = '&#187;'; */
    var $next_link       = '<span aria-hidden="true"><i class="fa fa-chevron-right" aria-hidden="true"></i></span> <span class="sr-only">Next</span>';
    /* var $prev_link       = '&#171;'; */
    var $prev_link       = '<span aria-hidden="true"><i class="fa fa-chevron-left" aria-hidden="true"></i></span> <span class="sr-only">Previous</span>';
    var $last_link       = 'Last';
    var $uri_segment     = 3;
