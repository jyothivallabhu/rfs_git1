			...
			<div class="page-header no-gutters">
				<div class="row align-items-md-center">
					...
					<div class="col-md-4 text-center">
						<h3 class="m-b-0">
						    <a class="text-dark" href="javascript:void(0);">Upload Artwork</a>
						</h3>
				...
				<div class="col-md-6 col-lg-6 offset-lg-3">
					<div class="card">
						<div class="card-body">
							 ...
							 <form action="<?=base_url('Artwork/create')?>" method="post" enctype="multipart/form-data" name="rfs_parent_form" id="rfs_parent_form">
								 <?php $this->load->view('include/msgs'); ?>
							
									<div class="form-group">
										<label for="inputState">Select Child</label>
										...
										<select id="section_id" name="section_id" class="form-control">
											<option selected="">Please Select</option>
												...
												?>
													<option value="<?=$c->section_id.'-'.$c->student_id?>" <?php if($childen['num'] == 1) echo 'selected'; ?>><?=$c->first_name?></option>
												<?php			
														}
									...
									<!--<div class="form-group">
										<label for="inputState">Image</label>
										 <input id="cropzee-input" name="artwork_upload" type="file" name="">
										 <input id="base_code" type="hidden" name="base_code" value="">
            ...
            <div class="ic-btns clearfix">
                <div id="ic-upload-btn" class="l but lrg file-button w3-button w3-blue">
                    <span id="ic-upload-btn-label" style="font-family: inherit;font-size: inherit;">Select Artwork</span>
...
<div id="ic-cropper-wrap1"></div>
            ...
            <!--</div>-->
								...
								<div class="form-group">
									<label class="font-weight-semibold" for="Status">Artist comment </label>
