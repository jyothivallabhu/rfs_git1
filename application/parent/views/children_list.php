			...
			<div class="page-header no-gutters">
				<div class="row align-items-md-center">
					...
					<div class="text-md-right m-v-10">
					    <a href="<?=base_url('Children/child_step1')?>" class="btn btn-primary">
						<i class="anticon anticon-plus"></i>
						<span class="m-l-5">Add Child</span>
					    </a>
					</div>
				    </div>
				</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="m-t-15 m-l-20">
								...
								<a href="<?= base_url('children/edit_child/'.$row->student_id) ?>" class="m-r-5 btn btn-icon btn-hover btn-rounded">
